...
export const { REACT_APP_MERCHANDISING_BASE_URL, REACT_APP_BASE_URL, REACT_APP_AUTH_BASE_URL } = process.env;
...
export const statusOptions = [
    ...
    { value: 'false', label: 'In-active', number: 2 }
];
