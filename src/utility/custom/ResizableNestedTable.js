...
const ResizableNestedTable = ( { className, mainClass, responsive, bordered, size, tableId, children, ...props } ) => {
...
export default ResizableNestedTable;
// ** PropTypes
ResizableNestedTable.propTypes = {
