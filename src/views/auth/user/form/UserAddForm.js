...
import { Button, Card, FormFeedback, FormGroup, Input, Label, Spinner } from 'reactstrap';
...
import { addUser, bindUserBasicInfo, userImageUpload } from '../store/actions';
                ...
                <>
                    <UILoader blocking={isUserDataSubmitProgress} loader={<ComponentSpinner />}  >
                        ...
                        <FormGroup>
                            ...
                            />
                            {
                                ( errors.userName && !isContainWhiteSpace( userBasicInfo?.userName ) ) &&
                        ...
                        <FormGroup>
                            ...
                            {/* <Input
                                ...
                                invalid={( errors.contactNumber && !isContainOnlySpace( userBasicInfo?.email ) ) && true}
