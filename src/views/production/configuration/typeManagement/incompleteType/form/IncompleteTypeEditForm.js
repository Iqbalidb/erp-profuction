...
import { toggleIncompleteTypeSidebar, toggleIncompleteTypeStatus, updateIncompleteType } from '../store/actions';
        ...
        <FormGroup>
          <Label for="status">
            <Input
              ...
              onChange={e => dispatch( toggleIncompleteTypeStatus( e.target.checked ? 'active' : 'inactive' ) )}
            />
