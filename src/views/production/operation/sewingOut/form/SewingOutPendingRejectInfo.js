/*
   Title: Sewing Out Pending Reject Info
   Description: Sewing Out Pending Reject Info
...
const SewingOutPendingRejectInfo = props => {
...
export default SewingOutPendingRejectInfo;
