/*
     Title: Finishing Todays Table Column
     Description: Finishing Todays Table Column
...
export const finishingTodaysTableColumn = [
    ...
    cell: row => (
      <UncontrolledDropdown>
        ...
        <DropdownMenu right>
          ...
          <Link to={{ pathname: '/finishing-edit', state: row }}>
            <DropdownItem className="w-100">
