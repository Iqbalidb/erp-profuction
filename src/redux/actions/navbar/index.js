...
import { productionNavigation } from 'navigation/productionNavigation';
...
export const bindNavigation = ( userPermission, authPermissions ) => async ( dispatch, getState ) => {
  ...
  const horizontalNav = [...anonymousNavigation, ...productionNavigation];

  const verticalNav = [...anonymousNavigation, ...productionNavigation];
